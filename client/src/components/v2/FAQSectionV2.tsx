...
const faqs = [
  {
    ...
    answer:
      "入会金も月額費用も一切かかりません。お支払いいただくのは野菜代金のみです。",
  },
  {
    id: "q1",
  ...
  },
  {
    ...
    answer:
      "お店の公式LINEを徹底的なヒアリングの後、構築いたします。来店時にはお店のこだわりをビジュアルでお伝えし、来店後は次回の来店を促す配信を行います。客単価とリピート率の向上を目指し、効果測定まで一貫してサポートいたします。詳細はヒアリング時にご説明いたします。",
  },
  {
    id: "q5",
