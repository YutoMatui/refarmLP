            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-8 px-2">
                    ...
                    <div className="bg-white rounded-3xl shadow-2xl overflow-visible relative flex flex-col pt-12 md:pt-14 border-4 border-white transform transition-transform hover:scale-[1.02] duration-300">
                        ...
                        <div className="px-6 flex-1 text-center pb-6">
                            ...
                            <p className="text-slate-500 text-xs md:text-sm">
                                PDF資料でベジコベのすべてがわかります。
                            </p>
                        </div>

                        {/* Bottom Button Area - 黄色/オレンジ系で緑背景に映える色に */}
                        <div className="mt-auto p-5 bg-amber-400 hover:bg-amber-300 active:bg-amber-500 transition-colors cursor-pointer group rounded-b-2xl"
                    ...
                    <div className="bg-white rounded-3xl shadow-2xl overflow-visible relative flex flex-col pt-12 md:pt-14 border-4 border-white transform transition-transform hover:scale-[1.02] duration-300">
                        {/* Floating Badge */}
                        <div className="absolute -top-4 -left-4 md:-top-6 md:-left-6 bg-white w-24 h-24 md:w-28 md:h-28 rounded-full shadow-lg flex flex-col items-center justify-center z-10 border-4 border-emerald-50 transform -rotate-12">
                            <span className="text-xs md:text-sm font-bold text-slate-500">今すぐ</span>
                            <span className="text-2xl md:text-3xl font-black text-orange-500 leading-none">無料</span>
                        </div>
                        ...
                        <div className="px-6 flex-1 text-center pb-6">
                            ...
                            <h3 className="text-lg md:text-xl font-bold text-slate-700 mb-2">
                                今すぐ無料で<br />
                                <span className="text-emerald-600">利用開始できます！</span>
                            </h3>
                            <p className="text-slate-500 text-xs md:text-sm">
                        ...
                        {/* Bottom Button Area */}
                        <div
                            className="mt-auto p-5 bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 transition-colors cursor-pointer group rounded-b-2xl"
                            onClick={() => handleLineClick("Free Start")}
                        >
                            <div className="flex items-center justify-center gap-2">
                                <span className="text-white font-black text-lg md:text-xl tracking-wide">
                                    無料で利用開始
                                </span>
                                <ChevronRight className="w-6 h-6 text-white group-hover:translate-x-1 transition-transform stroke-[3]" />
                            </div>
                        </div>
                    </div>
