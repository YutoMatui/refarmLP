...
export default function HeroSection() {
  ...
  return (
    <section className="relative min-h-[100vh] flex items-center overflow-hidden bg-white pt-20 md:pt-0">
      {/* 背景の装飾 */}
      ...
      <div className="container mx-auto px-4 py-4 md:py-16">
        <div className="flex flex-col lg:flex-row items-center gap-6 lg:gap-8">
          ...
          <div className="w-full lg:w-1/2 text-center lg:text-left z-10 order-3 lg:order-1 animate-fade-in-up">
            {/* PC用：タグ風の見出し - より上に配置 */}
            <div className="hidden lg:inline-flex flex-wrap items-center justify-start gap-4 mb-4">
            ...
            {/* CTAエリア */}
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-2 md:gap-4">
              <Button
                className="w-full sm:w-auto bg-orange-500 hover:bg-orange-600 text-white font-black text-sm md:text-lg py-5 md:py-7 px-6 md:px-10 rounded-2xl shadow-lg shadow-orange-200 transition-all hover:-translate-y-1 active:translate-y-0"
              ...
              <Button
                variant="outline"
                className="w-full sm:w-auto border-2 border-slate-200 text-slate-600 hover:bg-slate-50 font-bold text-sm md:text-lg py-5 md:py-7 px-6 md:px-10 rounded-2xl transition-all"
